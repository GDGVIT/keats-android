...
object Constants {
    const val BASE_URL = "https://keats-testing.herokuapp.com/"
    const val WS_BASE_URL = "ws://139.59.22.133/ws/chat/"
    const val PREF_NAME = "keats_app_pref"
    ...
    const val SPLASH_SCREEN_DELAY: Long = 700
}
